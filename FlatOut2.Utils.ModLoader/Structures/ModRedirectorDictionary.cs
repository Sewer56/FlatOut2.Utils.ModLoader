...
/// <summary>
/// Dictionary for tracking available files at runtime inside a folder.
/// </summary>
public class ModRedirectorDictionary : IDisposable
{
    /// <summary>
    /// Contains all redirects stored within this dictionary.
    /// </summary>
    public Dictionary<string, string> FileRedirects { get; set; } = new(StringComparer.OrdinalIgnoreCase);
